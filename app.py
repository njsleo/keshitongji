...
def clean_excel_data(df):
    ...
    for i in range(min(15, len(df))):
        ...
        # 【核心修复】：支持单双位数字匹配 \d{1,2}，如 2026/3/8 也能被瞬间识别！
    ...
    if st.session_state['teacher_mode']:
        ...
        if teacher_schedule:
            ...
            st.download_button(
                ...
                data=excel_data, file_name=f"{target_teacher}_全周期专属课表.xlsx",
